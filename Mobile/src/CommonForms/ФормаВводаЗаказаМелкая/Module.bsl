...
Процедура ОтправитьНаСерверНаСервере()
	...
	ПараметрОтправкиHC35.ОбработанныйНомерЗаказа = ОбработанныйНомерЗаказа;
	ПараметрОтправкиHC35.ОбработанныйНомерБухты = ОбработанныйНомерБухты;
	ПараметрОтправкиHC35.ОбработанныйКодОператора = ОбработанныйКодОператора;
